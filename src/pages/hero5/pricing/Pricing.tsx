...
export const Pricing = () => {
    return (
        <div className="min-h-screen max-w-7xl mx-auto mt-15 px-4">
            <div className="flex flex-col md:flex-row justify-center items-center gap-10 max-w-3xl mx-auto relative">
                <div className="flex flex-col justify-start items-start border border-gray-800 w-full md:w-1/2 h-auto md:h-[550px] p-6 py-8 max-w-md rounded-2xl space-y-3">
                ...
                <div className="flex flex-col justify-start items-start border border-gray-800 w-full md:w-1/2 h-auto md:h-[550px] p-6 py-10 max-w-md rounded-2xl space-y-3 relative">
                ...
                <span className="hidden md:block absolute inset-x-0 bottom-0 bg-gradient-to-r from-transparent via-neutral-100 to-transparent h-px w-full mx-auto" />
            </div>
        </div>
    )
}
